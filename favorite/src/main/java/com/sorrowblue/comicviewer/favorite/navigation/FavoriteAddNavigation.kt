...
import com.sorrowblue.comicviewer.favorite.add.FavoriteAddRoute
...
private const val FavoriteAddRoute = "$FavoriteListRoute/add"
...
fun NavGraphBuilder.favoriteAddScreen(onAddClick: () -> Unit) {
    composable(
        ...
        FavoriteAddRoute(onAddClick = onAddClick)
    }
}
