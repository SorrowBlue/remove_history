...
internal class FileInfoFragment : BottomSheetDialogFragment(R.layout.file_info_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.openFolder.setOnClickListener {
            requireParentFragment().findNavController().navigate("http://comicviewer.sorrowblue.com/folder?serverId=${viewModel.fileFlow.value!!.serverId.value}&path=${viewModel.fileFlow.value!!.parent.encodeBase64()}".toUri())
        }
    }
}
