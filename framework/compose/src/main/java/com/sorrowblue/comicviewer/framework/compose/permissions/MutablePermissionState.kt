...
/**
 * Creates a [MutablePermissionState] that is remembered across
 * compositions.
 *
...
/**
 * A mutable state object that can be used to control and observe
 ...
 * @param activity to check if the user should be presented with a
