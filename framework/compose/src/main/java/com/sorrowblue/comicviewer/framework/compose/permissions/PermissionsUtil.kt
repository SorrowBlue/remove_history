...
/**
 * Model of the status of a permission. It can be granted or denied. If
 * denied, the user might need to be presented with a rationale.
 */
@Stable
...
/**
 * Effect that updates the `hasPermission` state of a revoked
 * [MutablePermissionState] permission when the lifecycle gets called with
 * [lifecycleEvent].
 */
@Composable
 ...
 * when the lifecycle gets called with [lifecycleEvent] and the permission
 * is revoked.
 */
@Composable
