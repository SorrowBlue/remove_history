...
/**
 * Contains default values used by [Modifier.placeholder] and
...
/**
 * Draws some skeleton UI which is typically used whilst content is
 * 'loading'.
 *
 * A version of this modifier which uses appropriate values for Material
 * themed apps is available in the 'Placeholder Material' library.
 *
 * You can provide a [PlaceholderHighlight] which runs an highlight
 * animation on the placeholder. The [shimmer] and [fade] implementations
 * are provided for easy usage.
 *
 * A cross-fade transition will be applied to the content and placeholder
 * UI when the [visible] value changes. The transition can be customized
 * via the [contentFadeTransitionSpec] and [placeholderFadeTransitionSpec]
 * parameters.
 *
 ...
 * @param shape desired shape of the placeholder. Defaults to
 *     [RectangleShape].
 * @param highlight optional highlight animation.
 * @param placeholderFadeTransitionSpec The transition spec to use when
 *     fading the placeholder on/off screen. The boolean parameter defined
 *     for the transition is [visible].
...
/**
 * Returns the value used as the the `color` parameter value on
 * [Modifier.placeholder].
 *
 * @param backgroundColor The current background color of the layout.
 *     Defaults to `MaterialTheme.colorScheme.surface`.
 * @param contentColor The content color to be used on top of
 *     [backgroundColor].
 * @param contentAlpha The alpha component to set on [contentColor] when
 *     compositing the color on top of [backgroundColor]. Defaults to
 *     `0.1f`.
 */
@Composable
 ...
 * @param backgroundColor The current background color of the layout.
 *     Defaults to `MaterialTheme.colorScheme.surface`.
 * @param alpha The alpha component to set on [backgroundColor]. Defaults
 *     to `0.3f`.
 */
@Composable
 ...
 * 'loading'.
 *
 * To customize the color and shape of the placeholder, you can use the
 * foundation version of [Modifier.placeholder], along with the values
 * provided by [PlaceholderDefaults].
 *
 * A cross-fade transition will be applied to the content and placeholder
 * UI when the [visible] value changes. The transition can be customized
 * via the [contentFadeTransitionSpec] and [placeholderFadeTransitionSpec]
 ...
 *
 * @param visible whether the placeholder should be visible or not.
 * @param color the color used to draw the placeholder UI. If
 *     [Color.Unspecified] is provided, the placeholder will use
 *     [PlaceholderDefaults.color].
 * @param shape desired shape of the placeholder. If null is provided the
 *     placeholder will use the small shape set in [MaterialTheme.shapes].
 * @param highlight optional highlight animation.
 * @param placeholderFadeTransitionSpec The transition spec to use when
 *     fading the placeholder on/off screen. The boolean parameter defined
 *     for the transition is [visible].
