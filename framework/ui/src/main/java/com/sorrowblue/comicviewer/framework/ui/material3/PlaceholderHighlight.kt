...
interface PlaceholderHighlight {
    /**
     * The optional [AnimationSpec] to use when running the animation for this
     * highlight.
     */
    ...
    /**
     * Return the desired alpha value used for drawing the [Brush] returned
     * from [brush].
     *
     * @param progress the current animated progress in the range of 0f..1f.
     */
...
/**
 * Creates a [PlaceholderHighlight] which 'shimmers', using the given
 * [highlightColor].
 *
 * The highlight starts at the top-start, and then grows to the
 * bottom-end during the animation. During that time it is also
 * faded in, from 0f..progressForMaxAlpha, and then faded out from
 * progressForMaxAlpha..1f.
 *
 * @param highlightColor the color of the highlight 'shimmer'.
 * @param animationSpec the [AnimationSpec] to configure the animation.
 * @param progressForMaxAlpha The progress where the shimmer should be at
 *     it's peak opacity. Defaults to 0.6f.
 * @sample
 *     com.google.accompanist.sample.placeholder.DocSample_Foundation_PlaceholderShimmer
 */
...
/**
 * Creates a [PlaceholderHighlight] which fades in an appropriate color,
 * using the given [animationSpec].
 *
 * @param animationSpec the [AnimationSpec] to configure the animation.
 * @sample
...
/**
 * Creates a [PlaceholderHighlight] which 'shimmers', using a default
 * color.
 *
 * The highlight starts at the top-start, and then grows to the
 * bottom-end during the animation. During that time it is also
